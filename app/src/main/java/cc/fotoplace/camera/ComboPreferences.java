...
public class ComboPreferences implements
    ...
    private static boolean isGlobal(String key) {
        return key.equals(CameraSettings.KEY_VIDEO_TIME_LAPSE_FRAME_INTERVAL)
                ...
                || key.equals(CameraSettings.KEY_DEFAULT_SAVE_PATH)
                || key.equals(CameraSettings.KEY_FIRST_TIME_USE_CAMERA)
                || key.equals(CameraSettings.KEY_FACE_BEAUTY)
                || key.equals(CameraSettings.KEY_PHOTO_ALIGNMENT_LINES)
                || key.equals(CameraSettings.KEY_SUPPORT_FACE_BEAUTY)
                || key.equals(CameraSettings.KEY_FLASH_MODE)
                || key.equals(CameraSettings.KEY_VIDEOCAMERA_FLASH_MODE)
                || key.equals(CameraSettings.KEY_SCANCAMERA_FLASH_MODE);
    }
